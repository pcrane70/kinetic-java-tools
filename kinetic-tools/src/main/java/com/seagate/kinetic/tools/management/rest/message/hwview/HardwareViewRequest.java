...
public class HardwareViewRequest extends RestRequest {

    private String name = ServiceConfiguration.getHardwareConfigTempletName();

    public HardwareViewRequest() {
        super.setMessageType(MessageType.HARDWARE_VIEW);
    }
