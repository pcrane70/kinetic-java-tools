...
/**
 * Instant erase service handler.
 * 
 * @author chiaming
 *
 */
public class InstantEraseHandler extends GenericServiceHandler implements
        ServiceHandler {

    @SuppressWarnings("rawtypes")
    @Override
    public Class getRequestMessageClass() {
        return InstantEraseRequest.class;
    }
    ...
    protected void transformRequestParams(HttpServletRequest httpRequest,
        ...
        if (httpRequest.getContentLength() <= 0) {
            ...
            InstantEraseRequest request = (InstantEraseRequest) req;
