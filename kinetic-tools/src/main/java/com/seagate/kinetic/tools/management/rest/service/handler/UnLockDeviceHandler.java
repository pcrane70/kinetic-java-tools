...
/**
 * Unlock device service handler.
 * 
 * @author chiaming
 *
 */
public class UnLockDeviceHandler extends GenericServiceHandler implements
        ServiceHandler {

    @SuppressWarnings("rawtypes")
    @Override
    public Class getRequestMessageClass() {
        return UnLockDeviceRequest.class;
    }
    ...
    protected void transformRequestParams(HttpServletRequest httpRequest,
        ...
        if (httpRequest.getContentLength() <= 0) {
            ...
            UnLockDeviceRequest request = (UnLockDeviceRequest) req;
