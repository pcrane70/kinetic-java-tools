...
/**
 * Set lock pin service handler.
 * 
 * @author chiaming
 *
 */
public class SetLockPinHandler extends GenericServiceHandler implements
        ServiceHandler {

    @SuppressWarnings("rawtypes")
    @Override
    public Class getRequestMessageClass() {
        return SetLockPinRequest.class;
    }
    ...
    protected void transformRequestParams(HttpServletRequest httpRequest,
        ...
        if (httpRequest.getContentLength() <= 0) {
            ...
            SetLockPinRequest request = (SetLockPinRequest) req;
