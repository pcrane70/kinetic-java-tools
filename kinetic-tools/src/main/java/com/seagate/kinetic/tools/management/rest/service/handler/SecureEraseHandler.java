...
/**
 * Secure erase service handler.
 * 
 * @author chiaming
 *
 */
public class SecureEraseHandler extends GenericServiceHandler implements
        ServiceHandler {

    @SuppressWarnings("rawtypes")
    @Override
    public Class getRequestMessageClass() {
        return SecureEraseRequest.class;
    }
    ...
    protected void transformRequestParams(HttpServletRequest httpRequest,
        ...
        if (httpRequest.getContentLength() <= 0) {
            ...
            SecureEraseRequest request = (SecureEraseRequest) req;
